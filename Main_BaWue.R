...
pdf("KIPlotsBaWue.pdf", width = 10, height = 5,title="BaWue")
par("mar" = c(5, 4, 1.5, 2))
...
# CDU etwas heller, damit man Markierungen sehen kann
# parteifarben[1]="grey40" 
# parteifarben[8]="#C1CDCD" 
...
# Legende hinzufügen
legend("topright",
       legend=c("Umfragewert (Stand 29.01.2026)"),
       col=c("black"),
       lty=c(1),
       lwd=c(4),
       bty="n",
...
ggplot(partei_scores,
  ...
  labs(
    title = "Partei-Scores Baden-Württemberg",
    x = "Partei",
    y = "Score",
    fill = "Partei"
  ) +
